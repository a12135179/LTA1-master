...
if __name__ == '__main__':
    ...
    parser.add_argument('--source_type', type = str ,help = "image or video")
    parser.add_argument('--demo_data_path', type = str,default = "./demo/source", help = "a path of a dir to your demo data ")
